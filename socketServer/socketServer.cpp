...
#include <iostream>
#include <string>
#include "C:\Users\Filip\source\repos\server\base64.c"
#include "C:\Users\Filip\source\repos\server\sha1.c"
#include "C:\Users\Filip\source\repos\server\sha1.h"
#include <fstream>
#include <sstream>
...
int main() {
    ...
    char bufor[2048];
    string serverResponse = to_string(recv(mainSocket, bufor, 2048, 0));
    cout << serverResponse;

    string DECODED = "";
    for (int i = 0; i < serverResponse.length(); i++) {
        DECODED[i] = serverResponse ^ MASK[i % 4];
    }
